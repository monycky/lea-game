...
function scene:create( event )
    ...
    circleHolder = display.newImage("src/scenes/images/square-shape-color.png", 400, 150)
    sceneGroup:insert(circleHolder)

    circle = display.newImage("src/scenes/images/square-shape-color.png", 100, 150)
    sceneGroup:insert(circle)

    circle.name = 'circle'


    squareHolder = display.newImage("src/scenes/images/square-shape-color2.png", 400, 250)
    sceneGroup:insert(squareHolder)

    square = display.newImage("src/scenes/images/square-shape-color2.png", 100, 250)
