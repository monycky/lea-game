...
function showGameView:tap(e)
	...
	sHolder = display.newImage('square-shape-gray.png', 260, 100) -- OK
	
	pHolder = display.newImage('circular-shape-gray.png', 260, 230) -- OK
	...
	pentagon = display.newImage('circular-shape-color.png', 10, 230)
